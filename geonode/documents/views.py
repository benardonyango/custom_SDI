...
def _resolve_document(request, docid, permission='base.change_resourcebase',
    ...
    '''
    Resolve the document by the provided primary key and check
    ...
    if document is None:
        ...
        if request.method == "POST":
            ...
            category_form = CategoryForm(
                ...
                initial=int(
                    request.POST["category_choice_field"])
            ...
            if new_poc is not None and new_author is not None:
                ...
                if getattr(settings, 'SLACK_ENABLED', False):
                    try:
                        ...
                        send_slack_messages(build_slack_message_document(
                            "document_edit", the_document))
                    except:
                        print "Could not send slack message for modified \
                        document."
